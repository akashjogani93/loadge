...
<div class="page-content container-fluid" style="background-color:rgba(233, 245, 250, 1);">
    <div class="footer"style="background-color:rgba(233, 245, 250, 1);">
        <div class="d-flex justify-content-between">
             <h2 class="" style="font-size:36px; font-weight: 600">FRESH-UP CHECKOUT REPORT</h2>
        </div>
                ...
                <div class="innerbox">
                    <form action="" method="post" enctype="multipart/form-data"  style="padding:0 20px 0 20px;">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="group-form-btn col-md-2 " style="margin-top:45px;">
                                <a href="freshup_report.php" name="submit" class="btn btn-sm btn-info col-md-12">Refresh</a>
                            </div>
                        </div>
                    </form>
                    <br><br><br><br>
                           ...
                           <table id="example" class="table table-striped table-bordered">
                                ...
                                <tbody>                               
                                    <?php 
                                        ...
                                        {
                                            $qry="SELECT * FROM `freshup` WHERE `status`=1";
                                        }else
                                        {
                                            $from=$_POST['from'];
                                            $to=$_POST['to'];
                                            $qry="SELECT * FROM `freshup` WHERE `datetime` BETWEEN '$from' AND '$to' AND `status`=1";
                                        }
