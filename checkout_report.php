...
<div class="page-content container-fluid" style="background-color:rgba(233, 245, 250, 1);">
    <div class="footer"style="background-color:rgba(233, 245, 250, 1);">
        <div class="d-flex justify-content-between">
             <h2 class="" style="font-size:36px; font-weight: 600">CHECK OUT REPORT</h2>
        </div>
                ...
                <div class="innerbox">
                    <form action="" method="post" enctype="multipart/form-data"  style="padding:0 20px 0 20px;">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="group-form-btn col-md-2 " style="margin-top:45px;">
                                <a href="checkout_report.php" name="submit" class="btn btn-sm btn-info col-md-12">Refresh</a>
                            </div>
                        </div>
                    </form>
                    <br><br>
                                ...
                                <tbody>                               
                                    <?php 
                                        ...
                                        }else
                                        {
                                            $from=$_POST['from'];
                                            $to=$_POST['to'];
                                            $qry="SELECT `chek_in`.*,`check_out`.* FROM `chek_in`,`check_out` WHERE `check_out`.`checkout` BETWEEN '$from' AND '$to' AND `check_out`.`cust_id`=`chek_in`.`cust_id` ORDER BY `check_out`.`id`";
                                        }
